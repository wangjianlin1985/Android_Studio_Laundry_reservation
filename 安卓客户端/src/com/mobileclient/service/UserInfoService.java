...
public class UserInfoService {
	...
	public List<UserInfo> QueryUserInfo(UserInfo queryConditionUserInfo) throws Exception {
		...
		if(queryConditionUserInfo != null) {
			...
			urlString += "&regTime=" + URLEncoder.encode(queryConditionUserInfo.getRegTime(), "UTF-8") + "";
		}
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				userInfo.setLatitude((float) object.getDouble("latitude"));
				userInfo.setLongitude((float) object.getDouble("longitude"));
