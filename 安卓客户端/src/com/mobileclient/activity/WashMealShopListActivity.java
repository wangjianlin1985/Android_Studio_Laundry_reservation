...
public class WashMealShopListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(WashMealShopListActivity.this, WashMealQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(WashMealShopListActivity.this, WashMealShopAddActivity.class);
				startActivityForResult(intent,ActivityUtils.ADD_CODE);
			}
		});
		
		queryConditionWashMeal = new WashMeal();
		queryConditionWashMeal.setMealName("");
		queryConditionWashMeal.setPublishDate(null);
		queryConditionWashMeal.setWashShopObj(username);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new WashMealSimpleAdapter(WashMealShopListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(WashMealShopListActivity.this, WashMealDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑洗衣套餐信息
			...
			Intent intent = new Intent();
			intent.setClass(WashMealShopListActivity.this, WashMealEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("mealId", mealId);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(WashMealShopListActivity.this);
