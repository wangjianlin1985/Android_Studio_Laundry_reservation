...
public class MainMenuActivity extends Activity {
    ...
    public class ImageAdapter extends BaseAdapter {
        ...
        private String[] menuString = {"用户管理","洗衣店种类管理","洗衣套餐管理","套餐评价管理","订单管理","订单状态管理","洗衣店管理"};
        ...
        public View getView(int position, View convertView, ViewGroup parent) { 
			...
			iv.setImageResource(mThumbIds[position]); 
			  switch (position) {
				...
				case 1:
					// 洗衣店种类管理监听器
					view.setOnClickListener(washClassLinstener);
					break;
				case 2:
					// 洗衣套餐管理监听器
					view.setOnClickListener(washMealLinstener);
					break;
				case 3:
					// 套餐评价管理监听器
					view.setOnClickListener(mealEvaluateLinstener);
					break;
				case 4:
					// 订单管理监听器
				...
				case 6:
					// 洗衣店管理监听器
					view.setOnClickListener(washShopLinstener);
					break;
    ...
    OnClickListener washClassLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动洗衣店种类管理Activity
			intent.setClass(MainMenuActivity.this, WashClassListActivity.class);
			startActivity(intent);
		}
	};
    OnClickListener washMealLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动洗衣套餐管理Activity
			intent.setClass(MainMenuActivity.this, WashMealListActivity.class);
			startActivity(intent);
		}
	};
    OnClickListener mealEvaluateLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动套餐评价管理Activity
			intent.setClass(MainMenuActivity.this, MealEvaluateListActivity.class);
			startActivity(intent);
		}
	};
    ...
    OnClickListener washShopLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动洗衣店管理Activity
			intent.setClass(MainMenuActivity.this, WashShopListActivity.class);
			startActivity(intent);
		}
	};
