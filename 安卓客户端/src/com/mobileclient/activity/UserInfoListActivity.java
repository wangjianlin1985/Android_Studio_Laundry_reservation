				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new UserInfoSimpleAdapter(UserInfoListActivity.this, list,
	        					...
	        					new String[] { "user_name","name","sex","birthDate","userPhoto","regTime" },
	        					new int[] { R.id.tv_user_name,R.id.tv_name,R.id.tv_sex,R.id.tv_birthDate,R.id.iv_userPhoto,R.id.tv_regTime,},lv);
