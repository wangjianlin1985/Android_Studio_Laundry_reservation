...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"套餐评价","订单","洗衣店","修改个人信息","关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		else if(declare.getIdentify().equals("shop"))
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(declare.getIdentify().equals("user")) { 
					...
					if(arg2 == 0){
						...
						String user_name = declare.getUserName();
						Intent intent = new Intent();
						intent.setClass(MoreActivity.this, WashShopEditActivity.class);
						Bundle bundle = new Bundle();
						bundle.putString("shopUserName", user_name);
						intent.putExtras(bundle);
						startActivityForResult(intent,ActivityUtils.EDIT_CODE);
					...
					if(arg2 == 0){
						Intent intent  = new Intent(MoreActivity.this, MealEvaluateListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 1){
					...
					if(arg2 == 2){
						Intent intent  = new Intent(MoreActivity.this, WashShopListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 3){ 
