...
public class WashMealAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.washmeal_add); 
		...
		iv_mealPhoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(WashMealAddActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_mealName.getText().toString().equals("")) {
						Toast.makeText(WashMealAddActivity.this, "洗衣套餐输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_introduce.getText().toString().equals("")) {
						Toast.makeText(WashMealAddActivity.this, "套餐说明输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_price.getText().toString().equals("")) {
						Toast.makeText(WashMealAddActivity.this, "套餐价格输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(washMeal.getMealPhoto() != null) {
						...
						WashMealAddActivity.this.setTitle("正在上传图片，稍等...");
						String mealPhoto = HttpUtil.uploadFile(washMeal.getMealPhoto());
						WashMealAddActivity.this.setTitle("图片上传完毕！");
					...
					/*调用业务逻辑层上传洗衣套餐信息*/
					WashMealAddActivity.this.setTitle("正在上传洗衣套餐信息，稍等...");
