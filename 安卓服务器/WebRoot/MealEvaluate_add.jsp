...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <s:form action="MealEvaluate/MealEvaluate_AddMealEvaluate.action" method="post" id="mealEvaluateAddForm" onsubmit="return checkForm();"  enctype="multipart/form-data" name="form1">
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>评价内容:</td>
    <td width=70%><textarea id="mealEvaluate.evaluateContent" name="mealEvaluate.evaluateContent" rows="5" cols="50"></textarea></td>
  </tr>
  ...
  <tr>
    <td width=30%>评价时间:</td>
    <td width=70%><input id="mealEvaluate.evaluateTime" name="mealEvaluate.evaluateTime" type="text" size="20" /></td>
  </tr>
