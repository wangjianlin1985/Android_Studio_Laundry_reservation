...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>纬度:</td>
    <td width=70%><input id="userInfo.latitude" name="userInfo.latitude" type="text" size="8" /></td>
  </tr>

  <tr>
    <td width=30%>经度:</td>
    <td width=70%><input id="userInfo.longitude" name="userInfo.longitude" type="text" size="8" /></td>
  </tr>

  <tr>
    <td width=30%>注册时间:</td>
    <td width=70%><input id="userInfo.regTime" name="userInfo.regTime" type="text" size="20" /></td>
  </tr>
