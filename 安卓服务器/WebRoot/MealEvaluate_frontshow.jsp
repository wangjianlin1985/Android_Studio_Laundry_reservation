...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  <tr>
    <td width=30%>评价id:</td>
    <td width=70%><%=mealEvaluate.getEvaluateId() %></td>
  </tr>

  <tr>
    <td width=30%>被评套餐:</td>
    <td width=70%>
      <%=mealEvaluate.getWashMealObj().getMealName() %>
    </td>
  </tr>

  <tr>
    <td width=30%>评价内容:</td>
    <td width=70%><%=mealEvaluate.getEvaluateContent() %></td>
  </tr>

  <tr>
    <td width=30%>评价用户:</td>
    <td width=70%>
      <%=mealEvaluate.getUserObj().getName() %>
    </td>
  </tr>

  <tr>
    <td width=30%>评价时间:</td>
    <td width=70%><%=mealEvaluate.getEvaluateTime() %></td>
  </tr>
